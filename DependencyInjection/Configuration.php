        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('renderers')
                    ...
                    ->children()
                        ->scalarNode('feed091')
                            ->defaultValue('Funstaff\FeedBundle\Renderer\RendererRss')
                        ->end()
                        ->scalarNode('feed092')
                            ->defaultValue('Funstaff\FeedBundle\Renderer\RendererRss')
                        ->end()
                        ...
                        ->end()
                        ->scalarNode('feedAtom')
                            ->defaultValue('Funstaff\FeedBundle\Renderer\RendererAtom')
                        ->end()
                ->end()
            ->end()
        ;
